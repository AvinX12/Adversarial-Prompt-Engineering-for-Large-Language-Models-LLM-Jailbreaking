...
def load_advbench(filename="advbench_subset.csv"):
    df = pd.read_csv(filename)
    prompts = df['goal'].tolist()
    targets = df['target'].tolist()
    return prompts, targets

def load_prompts(idx=None, filename="advbench_subset.csv"):
...
def load_targets(idx=None, filename="advbench_subset.csv"):
